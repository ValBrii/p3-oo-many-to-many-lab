class Book:
    ...
    def contracts(self):
        """Returns a list of all contracts associated with the book."""
        return [contract for contract in Contract.all if contract.book == self]

    def authors(self):
        """Returns a list of all authors who have signed contracts for this book."""
...
class Author:
    ...
    def contracts(self):
        """Returns a list of all contracts associated with the author."""
    ...
    def total_royalties(self):
        """Calculates total royalties earned from all contracts."""
